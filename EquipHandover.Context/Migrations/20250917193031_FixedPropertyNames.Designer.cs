...
namespace EquipHandover.Context.Migrations
{
    ...
    [Migration("20250917193031_FixedPropertyNames")]
    partial class FixedPropertyNames
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EquipHandover.Entities.Sender", b =>
                {
                    ...
                    b.HasIndex(new[] { "TaxPayerNum" }, "IX_Sender_TaxPayerNum")
                        .IsUnique()
