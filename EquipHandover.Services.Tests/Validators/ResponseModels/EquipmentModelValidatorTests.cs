...
/// <summary>
/// Тесты для <see cref="EquipmentModelValidator"/>
/// </summary>
public class EquipmentModelValidatorTests
{
    private readonly EquipmentModelValidator validator;

    /// <summary>
    /// Инициализирует новый экземпляр <see cref="EquipmentModelValidatorTests"/>
    /// </summary>
    public EquipmentModelValidatorTests()
    {
        validator = new EquipmentModelValidator();
    }
